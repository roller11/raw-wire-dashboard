...
?>
        ...
        <style>
            ...
            .rawwire-form-horizontal .rawwire-form-row input[type="number"] {
                ...
                background: var(--rw-bg-surface, #fff);
                color: var(--rw-fg-default, #1d2327);
                border-color: var(--rw-border-default, #ccd0d4);
            }
            ...
            .rawwire-concepts-table th,
            .rawwire-concepts-table td {
                background: var(--rw-bg-surface, #fff);
                color: var(--rw-fg-default, #1d2327);
                border-color: var(--rw-border-muted, #eee);
            }

            .rawwire-concepts-table thead th {
            ...
            .rawwire-results-summary {
                background: var(--rw-bg-muted, #f6f7f7);
                color: var(--rw-fg-default, #1d2327);
                padding: 15px;
                border-radius: 4px;
                margin-bottom: 15px;
            ...
            .rawwire-result-item {
                padding: 12px;
                border: 1px solid var(--rw-border-default, #ddd);
                border-radius: 4px;
                margin-bottom: 10px;
                background: var(--rw-bg-surface, #fff);
                color: var(--rw-fg-default, #1d2327);
            ...
            .score-badge {
                ...
                border-radius: 50%;
                background: var(--rw-accent-primary, #0073aa);
                color: #fff;
            }
            ...
            .rawwire-key-row {
                padding: 12px;
                margin-bottom: 10px;
                background: var(--rw-bg-muted, #fafafa);
                border: 1px solid var(--rw-border-default, #ddd);
                border-radius: 4px;
            }
            ...
            .rawwire-key-configured {
                color: var(--rw-accent-success, #00a32a);
            }

            .rawwire-key-missing {
                color: var(--rw-accent-warning, #dba617);
            }
            ...
            .rawwire-weight-help {
                ...
                width: 16px;
                height: 16px;
                background: var(--rw-bg-elevated, #ddd);
                border-radius: 50%;
                font-size: 11px;
                cursor: help;
                color: var(--rw-fg-muted, #666);
            ...
            .rawwire-weights-total {
                margin: 15px 0;
                padding: 10px;
                background: var(--rw-bg-muted, #f5f5f5);
                border-radius: 4px;
                display: flex;
                align-items: center;
                gap: 10px;
...
<?php
    ...
    public function ajax_save_config()
    {
        // Accept either nonce
        if (
            !wp_verify_nonce($_POST['_wpnonce'] ?? '', 'rawwire_key_manager') &&
